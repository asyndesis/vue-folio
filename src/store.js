    ...
    portfolio: [
      {
        ...
        images: [
          {
            image: "full-harpies-1.jpg",
            desc: "Uses socket.io rooms to separate players on different maps.",
            align: "top"
          },
          {
            image: "full-harpies-2.jpg",
            desc: "Maps are built with tiled and imported as JSON",
            align: "top"
          }
        ],
        description:
          "A multiplayer role playing game written entirely in Javascript.",
      ...
      },
      {
        ...
        images: [
          {
            image: "full-fridge-poet-1.jpg",
            desc: "Simple login using localstorage API",
            align: "top"
          },
          {
            image: "full-fridge-poet-2.jpg",
            desc:
              "Rooms can be created with various options. The slug is generated based on the room name.",
            align: "top"
          },
          {
            image: "full-fridge-poet-3.jpg",
            desc:
              "Words are randomly spawned based on selected poetry kits. Moving a word will update the websocket server."
          }
        ],
        description: "A multiplayer magnetic poetry game.",
        tech: ["React", "Socket.io", "Express", "Node.js"],
        note: "I'm a real softie for a good poem.",
      ...
      },
      {
        ...
        images: [
          {
            image: "full-savviform-1.jpg",
            desc:
              "View of form builder. Here is where a user can create a form.",
            align: "top"
          },
          {
            image: "full-savviform-2.jpg",
            desc:
              "View of the rendered form. A front end user can fill this form out and it will save their progress to localstorage.",
            align: "top"
          }
        ],
        description: "A dynamic formbuilder.",
        note: "Drag and drop fields to build a form.",
        tech: ["jQuery", "Bootstrap", "PHP", "wkhtmltopdf"],
      ...
      },
      {
        ...
        images: [
          {
            image: "full-caregogi-4.jpg",
            desc: "View of the careseeker dashboard.",
            align: "top"
          },
          {
            image: "full-caregogi-1.jpg",
            desc:
              "A careseeker can send schedule requests by booking caregivers to certain dates on this screen."
          },
          {
            image: "full-caregogi-2.jpg",
            desc: "View of options when editing a shift."
          },
          { image: "full-caregogi-3.jpg", desc: "The quick scheduler screen." }
        ],
        tech: ["jQuery", "PHP", "Bootstrap", "Laravel", "Fullcalendar"],
        note: "Feels like a small social network.",
      ...
      },
      {
        ...
        images: [
          {
            image: "full-interworx-1.jpg",
            desc:
              "Homepage was redesigned and rebranded with purple as the new base color.",
            align: "top"
          },
          {
            image: "full-interworx-3.jpg",
            desc:
              "The feature page was built for customers to get a birds eye view.",
            align: "top"
          },
          {
            image: "full-interworx-2.jpg",
            desc:
              "The software itself now defaults to this purple theme out of the box.",
            align: "top"
          },
          {
            image: "full-interworx-5.jpg",
            desc: "View of Nodeworx on a phone or tablet.",
            align: "top",
            size: "contain"
          },
          {
            image: "full-interworx-4.jpg",
            desc: "CSS restyle of LATEX documentation.",
            align: "top"
          }
        ],
        description:
          "Redesign, rebuild and rebranding of website and software.",
        note: "Brought purple into their styleguide.",
        tech: ["wordpress", "scss", "photoshop"],
        url:
          "https://web.archive.org/web/20180708032557/http://www.interworx.com/"
      },
      {
        id: 5,
        ...
        images: [
          {
            image: "full-na-1.jpg",
            desc:
              "The client dashboard was built so that widgets could be added, moved, edited or removed.",
            align: "top"
          },
          {
            image: "full-na-2.jpg",
            desc:
              "The call list interface was designed for clients to reset codes on the fly in bulk.",
            align: "top"
          },
          {
            image: "full-na-3.jpg",
            desc:
              "Various admin screens for controlling client widgets. (Note the cute little frozen icon)",
            align: "top"
          }
        ],
        tech: ["laravel", "PHP", "jquery", "bootstrap"],
        note: "Dashboards are kind of my jam.",
        description:
          "Design and code of security dashboard and various interfaces."
      },
      {
        id: 6,
        title: "Medrespond",
        ...
        images: [
          {
            image: "full-medrespond-1.jpg",
            desc:
              "Ask a question in the box and text analysis will provide the appropriate video response.",
            align: "top"
          },
          {
            image: "full-medrespond-2.jpg",
            desc:
              "Guided learning programs were used by thousands of applicants.",
            align: "top"
          },
          {
            image: "full-medrespond-3.jpg",
            desc:
              "The software supported various kinds of tests along the way inbetween and even below video segments.",
            align: "top"
          }
        ],
        tech: ["angular.js", "PHP", "jquery", "bootstrap", "codeigniter"],
        note: "Lots of videos. Lots of varied user input.",
      ...
      */
      {
        ...
        images: [
          {
            image: "full-microbac-1.jpg",
            desc:
              "A bunch of different widgets were created so that the client could add different elements in the Savvior CMS.",
            align: "top"
          },
          {
            image: "full-microbac-2.jpg",
            desc: "View of expanding side-by-side widgets.",
            align: "top"
          },
          {
            image: "full-microbac-3.jpg",
            desc: "View of safety page on mobile.",
            align: "top",
            size: "contain"
          }
        ],
        tech: ["savvicms", "php", "illustrator", "bootstrap", "PHP", "SCSS"],
        note: "Custom CMS, Reusable Widgets",
        description:
          "Code of CMS template and site build for various resolutions."
      },
      {
        id: 7,
        ...
        images: [
          {
            image: "full-deiwert-1.jpg",
            desc: "View of auto insurance page.",
            align: "top"
          },
          {
            image: "full-deiwert-2.jpg",
            desc: "Mobile website view.",
            align: "top",
            size: "contain"
          }
        ],
        tech: ["wordpress", "photoshop", "jquery", "bootstrap", "PHP"],
        note: "Wordpress is where I got my roots.",
        description: "Design and code of Wordpress theme."
      }
      /*
      {
  ...
  getters: {
    ...
    getFolioById: state => id => {
      ...
      return {
        ...
        images: [{ image: "placeholder.jpg", desc: "arf" }],
        description: "",
        url: ""
      };
    }
